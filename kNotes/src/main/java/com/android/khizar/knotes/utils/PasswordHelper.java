...
import com.android.khizar.knotes.models.PasswordValidator;
...
public class PasswordHelper {
	...
	public static void resetPassword(final Activity mActivity) {
		...
		new MaterialDialog.Builder(mActivity)
				.title(KNotes.getSharedPreferences().getString(Constants.PREF_PASSWORD_QUESTION, ""))
				...
				.onPositive((dialog, which) -> {
					...
					String oldAnswer = KNotes.getSharedPreferences().getString(Constants.PREF_PASSWORD_ANSWER, "");
	...
	public static void removePassword() {
		Observable
				...
				.doOnCompleted(() -> {
					...
					KNotes.getSharedPreferences().edit()
