...
public class Navigation {
    ...
    public static int getNavigation() {
        String[] navigationListCodes = KNotes.getAppContext().getResources().getStringArray(com.android.khizar.knotes.R.array.navigation_list_codes);
    ...
    public static String getNavigationText() {
        Context mContext = KNotes.getAppContext();
        String[] navigationListCodes = mContext.getResources().getStringArray(com.android.khizar.knotes.R.array.navigation_list_codes);
    ...
    public static Long getCategory() {
        if (getNavigation() == CATEGORY) {
			return Long.valueOf(KNotes.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context
