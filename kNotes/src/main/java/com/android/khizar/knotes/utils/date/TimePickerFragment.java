...
public class TimePickerFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TimePickerDialog tpd = new TimePickerDialog(mActivity, com.android.khizar.knotes.R.style.Theme_AppCompat_Dialog_NoBackgroundOrDim, mListener, hour, minute, is24HourMode);
        tpd.setTitle("");
        return tpd;
    }
