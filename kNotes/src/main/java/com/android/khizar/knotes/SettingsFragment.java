...
import com.android.khizar.knotes.async.DataBackupIntentService;
import com.android.khizar.knotes.models.ONStyle;
import com.android.khizar.knotes.utils.SystemHelper;
...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null && getArguments().containsKey(XML_NAME)) {
			xmlId = ResourcesUtils.getXmlId(KNotes.getAppContext(), ResourcesUtils.ResourceIdentifiers.xml, String
	...
	public void onResume() {
		...
		if (changelog != null) {
			changelog.setOnPreferenceClickListener(arg0 -> {
				...
				/*((KNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_changelog");
				...
				new MaterialDialog.Builder(getActivity())
						...
						.callback(new MaterialDialog.ButtonCallback() {
							...
							public void onPositive(MaterialDialog materialDialog) {
								...
								/*((KNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_tour_show_again");
*/
					...
					new MaterialDialog.Builder(getActivity())
							...
							.callback(new MaterialDialog.ButtonCallback() {
								...
								public void onPositive(MaterialDialog materialDialog) {
									...
									/*((KNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING,
	...
	private void export(View v) {
		...
		new MaterialDialog.Builder(getActivity())
				...
				.callback(new MaterialDialog.ButtonCallback() {
					@Override
					public void onPositive(MaterialDialog materialDialog) {
						/*((KNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_export_data");*/
