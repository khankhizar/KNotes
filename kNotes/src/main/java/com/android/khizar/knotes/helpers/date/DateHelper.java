 ...
 */
package com.android.khizar.knotes.helpers.date;
...
public class DateHelper {
    ...
    public static String getNoteReminderText(long reminder) {
        return KNotes.getAppContext().getString(R.string.alarm_set_on) + " " + getDateTimeShort(KNotes
				.getAppContext(), reminder);
    }


    public static String getNoteRecurrentReminderText(long reminder, String rrule) {
        return DateHelper.formatRecurrence(KNotes.getAppContext(), rrule) + " " + KNotes.getAppContext().getString
                (R.string.starting_from) + " " + DateHelper.getDateTimeShort(KNotes.getAppContext(), reminder);
    }


	public static String getFormattedDate(Long timestamp, boolean prettified) {
		if(prettified) {
			return com.android.khizar.knotes.utils.date.DateUtils.prettyTime(timestamp);
		} else {
			return DateHelper.getDateTimeShort(KNotes.getAppContext(), timestamp);
		}
	}
