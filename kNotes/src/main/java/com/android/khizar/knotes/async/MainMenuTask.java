...
import com.android.khizar.knotes.async.bus.NavigationUpdatedEvent;
import com.android.khizar.knotes.models.NavigationItem;
import com.android.khizar.knotes.models.adapters.NavDrawerAdapter;
import com.android.khizar.knotes.models.views.NonScrollableListView;
...
import com.android.khizar.knotes.models.misc.DynamicNavigationLookupTable;
...
public class MainMenuTask extends AsyncTask<Void, Void, List<NavigationItem>> {
    ...
    @BindView(com.android.khizar.knotes.R.id.drawer_nav_list)
    NonScrollableListView mDrawerList;
    @BindView(com.android.khizar.knotes.R.id.drawer_tag_list) NonScrollableListView mDrawerCategoriesList;
    ...
    protected void onPostExecute(final List<NavigationItem> items) {
        if (isAlive()) {
            ...
            mDrawerList.setOnItemClickListener((arg0, arg1, position, arg3) -> {
				String navigation = mFragmentWeakReference.get().getResources().getStringArray(com.android.khizar.knotes.R.array
    ...
    private List<NavigationItem> buildMainMenu() {
        ...
        String[] mNavigationArray = mainActivity.getResources().getStringArray(com.android.khizar.knotes.R.array.navigation_list);
        TypedArray mNavigationIconsArray = mainActivity.getResources().obtainTypedArray(com.android.khizar.knotes.R.array.navigation_list_icons);
        TypedArray mNavigationIconsSelectedArray = mainActivity.getResources().obtainTypedArray(com.android.khizar.knotes.R.array
