 ...
 */
package com.android.khizar.knotes.db;
...
import com.android.khizar.knotes.async.upgrade.UpgradeProcessor;
import com.android.khizar.knotes.models.Stats;
...
public class DbHelper extends SQLiteOpenHelper {
	...
	public static synchronized DbHelper getInstance() {
		return getInstance(KNotes.getAppContext());
	}
