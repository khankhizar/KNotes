...
The project was created with  an attractive look and aligned with the most recent design of the Google operating system
...
They're all listed into the [build.gradle](https://github.com/federicoiosue/k-notes/blob/develop/omniNotes/build.gradle) file but due to the fact that many of the dependences have been customized by me I'd like to say thanks here to the original developers of these great libraries:
